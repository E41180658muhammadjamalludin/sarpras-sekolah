...
$pdf->Cell(25.5,0.8,"Laporan Pengembalian",0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(5,0.7,"Di cetak pada : ".date("D d-m-Y"),0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(1.8, 0.8, 'Id', 1, 0, 'C');
$pdf->Cell(2.3, 0.8, 'No Pinjam', 1, 0, 'C');
$pdf->Cell(2.5, 0.8, 'Tgl Pinjam', 1, 0, 'C');
$pdf->Cell(2.5, 0.8, 'Kode Barang', 1, 0, 'C');
$pdf->Cell(5, 0.8, 'Nama Barang', 1, 0, 'C');
$pdf->Cell(2.5, 0.8, 'Jml Pinjam', 1, 0, 'C');
$pdf->Cell(2.5, 0.8, 'Peminjam', 1, 0, 'C');
$pdf->Cell(2.5, 0.8, 'Tgl kembali', 1, 0, 'C');
...
while($lihat=mysqli_fetch_assoc($query)){ 
	$pdf->Cell(1.8, 0.8, $lihat['no_pengembalian'] ,1, 0, 'C');
	$pdf->Cell(2.3, 0.8, $lihat['no_pinjam'],1, 0, 'L');
	$pdf->Cell(2.5, 0.8, $lihat['tgl_pinjam'],1, 0, 'L');
	$pdf->Cell(2.5, 0.8, $lihat['kode_barang'], 1, 0,'C');
	$pdf->Cell(5, 0.8, $lihat['nama_barang'], 1, 0,'C');
	$pdf->Cell(2.5, 0.8, $lihat['jml_pinjam'], 1, 0,'C');
	$pdf->Cell(2.5, 0.8, $lihat['peminjam'], 1, 0,'C');
	$pdf->Cell(2.5, 0.8, $lihat['tgl_kembali'], 1, 0,'C');
	$pdf->Cell(4.5, 0.8, $lihat['ket'],1, 1, 'C');
	}
